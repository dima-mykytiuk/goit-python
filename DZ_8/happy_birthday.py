...
def get_birthday_per_week(users):
    ...
    while delta_days != 8:
        for item in users:
            valid_days = datetime.date.today() + datetime.timedelta(days=delta_days)
    ...
    for item in valid_list:
        ...
        if date.strftime("%A") in ['Saturday', 'Sunday', 'Monday']:
...
if __name__ == '__main__':
    ...
    get_birthday_per_week([{'name': 'Dmytro', 'birthday': datetime.datetime(2021, 10, 17)},
           {'name': 'Anton', 'birthday': datetime.datetime(2021, 10, 5)},
           {'name': 'Petya', 'birthday': datetime.datetime(2021, 10, 26)},
           {'name': 'Alex', 'birthday': datetime.datetime(2021, 11, 30)},
           {'name': 'Tolya', 'birthday': datetime.datetime(2021, 10, 28)},
           {'name': 'Vasya', 'birthday': datetime.datetime(2021, 10, 23)},
           {'name': 'Nick', 'birthday': datetime.datetime(2021, 10, 25)},
           {'name': 'Nikita', 'birthday': datetime.datetime(2021, 10, 26)},
           {'name': 'Vitaliy', 'birthday': datetime.datetime(2021, 10, 30)}])
